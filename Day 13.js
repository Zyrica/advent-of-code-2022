const isNumber = v => typeof v === typeof 0;
...
const task2 = input => input
  ...
  .concat([[[2]], [[6]]])
  .sort(compare)
  .reduce((a, v, i) => ['[[2]]', '[[6]]'].includes(JSON.stringify(v)) ? [i + 1, ...a] : a, [])
  .reduce((a, v) => a * v, 1);

const input = `[[[[8,6]],[8,[7],[6,7,6,2,4]],10,[[1,7,9],7,[7,9]]],[[4,[],[10,5],[5,4,7],5],8,9,[[5,3,3,6,9],[9,5,10],8],[[0,6,9],[8],4,6,8]]]
